                        ...
                        {newFields.map((field, index) => (
                            ...
                            >
                                <TableCell component="th" scope="row">
                                    <TextField
                                        fullWidth
                                        error={field['name'] === '' && editing && index !== newFields.length - 1}
                                        required
                                ...
                                <TableCell align="left">
                                    <FormControl
                                        fullWidth
                                        error={field['type'] === '' && editing && index !== newFields.length - 1}
                                        required
                                        sx={{ m: 1, minWidth: 120 }}
                                        size="small"
                                    >
                                ...
                                <TableCell align="left">
                                    <FormControl
                                        fullWidth
                                        error={field['required'] === '' && editing && index !== newFields.length - 1}
                                        required
                                        sx={{ m: 1, minWidth: 120 }}
                                        size="small"
                                    >
