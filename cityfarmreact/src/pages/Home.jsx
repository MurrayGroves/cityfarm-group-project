...
const Home = ({ farms }) => {
    ...
    return (
        <>
            ...
            <p>
                Welcome to the livestock manager application for the livestock managers of city farms across the Bristol
                area!
                <br />
            ...
            <ul>
                <li>
                    <a style={{ '--colour': colour }} href="https://www.windmillhillcityfarm.org.uk/" target="_blank">
                        Windmill Hill
                    </a>
                </li>
                <li>
                    <a style={{ '--colour': colour }} href="https://www.swcityfarm.co.uk/" target="_blank">
                        St Werburghs
                    </a>
                </li>
                <li>
                    <a style={{ '--colour': colour }} href="https://hartcliffecityfarm.org.uk/" target="_blank">
                        Hartcliffe
                    </a>
                </li>
            </ul>
            <p>
                ...
                <br />
                Hover over the question mark on the nav bar in any page to see useful help on that page and click it for
                an overall view of the entire website.
            </p>
            <br />
                        ...
                        {e.allDay ? (
                            <div>
                                <p>
                                    ...
                                    {e.end == null ? (
                                        <></>
                                    ) : e.end.toLocaleDateString() === e.start.toLocaleDateString() ? (
                                        <></>
                                    ) : (
