			...
			<LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale={"en-gb"}>
				...
				<Router>
					<Routes>
						<Route
							path="/login"
							element={<Login msal={msal} setMsal={setMsal} />}
						/>
						<Route
							exact
							path="*"
								...
								<>
									...
									<div className="Content">
										<Routes>
											...
											<Route
												path="/calendar"
												element={<Calendar farms={farms} />}
											/>
											<Route
												path="/animals"
												element={<AnimalTable farms={farms} />}
											/>
											<Route
												path="/enclosures"
												element={<EnclosureTable farms={farms} />}
											/>
											<Route
												path="/schemas"
												element={<Schemas farms={farms} />}
											/>
											<Route path="/help" element={<Help />} />
											<Route
												path="/single-animal/:animalID"
												element={<SingleAnimal farms={farms} />}
											/>
