...
const CreateEvent = (props) => {
    ...
    function addEvent(){ /* updates the newEvent in the Calendar and then calls a function to add the event to the database */
        ...
        <div>
            ...
            <div style={{marginTop: "10px"}}>
               ...
               onChange={()=>changeAllDay(!newEvent.allDay)}/>
                All day
                <button style={{float: "right"}} onClick={addEvent}>Add Event</button>
            </div>
        </div>
    </div>
    )
